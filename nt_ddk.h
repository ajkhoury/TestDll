...
typedef NTSTATUS(NTAPI *tLdrpLoadDll_10)(IN PUNICODE_STRING ModuleFile, IN PDLL_PATH_STRUCT DstFile, IN ULONG DLLCharacteristics, IN bool CallInit, OUT PHANDLE ModuleOut);

static unsigned char sigLdrpLoadDll_10_64[] = { 0x48, 0x89, 0x5C, 0x24, 0xCC, 0x48, 0x89, 0x74, 0x24, 0xCC, 0x55, 0x57, 0x41, 0x54, 0x41, 0x56, 0x41, 0x57, 0x48, 0x8D, 0x6C, 0x24, 0xCC, 0x48, 0x81, 0xEC, 0xCC, 0xCC, 0xCC, 0xCC, 0x48, 0x8B, 0x05, 0xCC, 0xCC, 0xCC, 0xCC, 0x48, 0x33, 0xC4, 0x48, 0x89, 0x45, 0x60, 0x4C, 0x8B, 0xBD, 0xC0 };
static unsigned char sigLdrpInitializeDllPath_64[] = { 0x48, 0x89, 0x5C, 0x24, 0xCC, 0x48, 0x89, 0x6C, 0x24, 0xCC, 0x48, 0x89, 0x74, 0x24, 0xCC, 0x57, 0x48, 0x83, 0xEC, 0x30, 0x49, 0x8B, 0xF8 };
//48 89 5C 24 ? 48 89 74 24 ? 55 57 41 54 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 45 60

static unsigned char sigLdrpLoadDll_10_32[] = { 0x8B, 0xFF, 0x55, 0x8B, 0xEC, 0x83, 0xE4, 0xF8, 0x81, 0xEC, 0xCC, 0xCC, 0xCC, 0xCC, 0xA1, 0xCC, 0xCC, 0xCC, 0xCC, 0x33, 0xC4, 0x89, 0x84, 0x24, 0xCC, 0xCC, 0xCC, 0xCC, 0x80, 0x3D };
static unsigned char sigLdrpInitializeDllPath_32[] = { 0x8B, 0xFF, 0x55, 0x8B, 0xEC, 0x53, 0x56, 0x8B, 0x75, 0x08, 0x8B, 0xDA, 0x57, 0x6A, 0x50 };

// Windows 7
//
typedef NTSTATUS(NTAPI *tLdrpLoadDll_7)(IN PUNICODE_STRING ModuleFile, IN PUNICODE_STRING PathToFile, IN ULONG DLLCharacteristics, IN bool CallInit, IN ULONGLONG Redirected, OUT PHANDLE ModuleHandle);

static unsigned char sigLdrpLoadDll_7_64[] = { 0xFF, 0xF3, 0x56, 0x57, 0x41, 0x54, 0x41, 0x55, 0x41, 0x56, 0x41, 0x57, 0x48, 0x81, 0xEC, 0xCC, 0xCC, 0xCC, 0xCC, 0x48, 0x8B, 0x05, 0xCC, 0xCC, 0xCC, 0xCC, 0x48, 0x33, 0xC4, 0x48, 0x89, 0x84, 0x24, 0xCC, 0xCC, 0xCC, 0xCC, 0x44, 0x88, 0x4C, 0x24 };
static unsigned char sigLdrpLoadDll_7_32[] = { 0x8B, 0xFF, 0x55, 0x8B, 0xEC, 0x83, 0xE4, 0xF8, 0x81, 0xEC, 0xCC, 0xCC, 0xCC, 0xCC, 0xA1, 0xCC, 0xCC, 0xCC, 0xCC, 0x33, 0xC4, 0x89, 0x84, 0x24, 0xCC, 0xCC, 0xCC, 0xCC, 0x80, 0x3D };
